...
import com.fammeo.app.adapter.Company.CompanyListAdapter;
...
import static com.fammeo.app.constants.Constants.METHOD_COMPANY_GET;
...
public class CompanyFragment extends BaseExampleFragment
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(getArguments() != null){
			...
			Log.e("TEST","Argument :"+getArguments().getString("params"));
	...
	private void filtergetcompanies(final String conId) {
		Log.e("TEST","CRId methode :"+conId);
		ExistingCompanies.clear();
...
//					try {
//						filterExpression.put("Status","All");
//						filterExpression.put("UserId",conId);
//						if(Filter_CRIds != null)
//						{
//							JSONArray CRIds = new JSONArray();
//							for (Long CRId: Filter_CRIds) {
...
//						}
					...
					filterType.put("UserId",Integer.parseInt(conId));
					params.put("filterExpression",filterType);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		/*if (requestCode == CONTACT_NEW_USER && resultCode == getActivity().RESULT_OK && null != data) {
			...
			CompanyRelationJ saveduser = data.getParcelableExtra("CompanyRelationJ");
